...
//                    console.log(cccs[x]);
                    var cardtext = "<li class='' data-cbreeze-cardid='"+id+"'><div class='row'><div class='col s12'><div class=''><div class='card "+cccs[x].materialname+"'><div class='card-content white-text'><div class='center col s12'><span class='card-title'><div class='col s2'>"+pri+"</div><div class='col s8'>"+na+"</div><div class='col s2'><a href='#' class='btn-flat edit-card-icon' onclick='popupeditcard("+id+")'><i class='mdi-editor-border-color'></i></a></div></span></div><p>[WHAT GOES HERE?]</p></div><div class='card-action center'><a href='#card"+id+"' onclick='popupmodal("+id+");'>Card Information</a><a href='#actions' data-cbreeze-card-ID-"+id+" onclick='popupaction("+id+");'>Activites</a></div></div></div></div></div></li>";
